        ...
        <div>
            <header className="flex items-center justify-between p-2 bg-white">
                ...
                <div className="flex items-center space-x-4 z-10">
                    ...
                    <Link href="/signup">
                        <button className="p-3 hover:underline cursor-pointer bg-orange-600 rounded-lg text-black font-sans font-semibold">
                            Sign Up
                        </button>
                    </Link>
                    <Link href="/login">
                        <button className="p-3 pr-4 pl-4 hover:underline cursor-pointer bg-orange-300 rounded-lg text-black font-sans font-semibold">
                            Login
                        </button>
                    </Link>
                </div>
